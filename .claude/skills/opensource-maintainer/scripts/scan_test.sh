...
D=$(make_repo \
  '.claude/skills/opensource-maintainer/allowlist.txt|fixtures.go|Secret = "SyntheticFixtureValue1|합성 픽스처' \
...
D=$(make_repo \
  '.claude/skills/opensource-maintainer/allowlist.txt|only.go|Secret = "SyntheticFixtureValue1|합성 픽스처
.claude/skills/opensource-maintainer/allowlist.txt|Secret = "SyntheticFixtureValue1|자기참조 줄' \
...
D=$(make_repo \
  '.claude/skills/opensource-maintainer/allowlist.txt|ext.go|Secret = "SyntheticFixtureValue1|합성 픽스처' \
  'ext.go|const fixtureSecret = "SyntheticFixtureValue1"
const sneakySecret = "SyntheticFixtureValue1PLUSREALSECRET"')
OUT=$(run_scan bash "$D" --all); RC=$?
...
D=$(make_repo \
  '.claude/skills/opensource-maintainer/allowlist.txt|conf.json|client_secret":"AllowedFixtureValue1|합성 픽스처' \
